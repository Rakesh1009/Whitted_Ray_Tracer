...
namespace rt
{
	...
	public:
		...
		**/ 
		virtual color_t direct(const ray_t& ray, const Vector3d& hitpt, const Vector3d& normal, const object_t* obj, const scene_t* scn) const = 0;
	...
	public:
		...
		* of direct illumination and the shadow computations.
		**/ 
		virtual color_t direct(const ray_t& ray, const Vector3d& hitpt, const Vector3d& normal, const object_t* obj, const scene_t* scn) const;
