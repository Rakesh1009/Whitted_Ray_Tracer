...
namespace rt
{
	...
	**/
	...
	public:
		...
		virtual color_t get_diffuse(const Vector2d coord) const = 0;
	...
	**/
	...
	public:
		...
		/// Returns the diffuse coefficient (kd) for direct illumination.
		virtual color_t get_diffuse(const Vector2d coord = Vector2d(0,0)) const;
		/// Returns the specular reflection coefficient (ks) for direct illumination.
	...
	/**
	* \brief This implements a class to represent solid surface materials with texture.
	**/
	class texturemat_t : public simplemat_t
	{
	private:
		/// Material Coefficients
	...
	public:
		...
		/// Destructor.
		virtual ~texturemat_t();
		/// Returns the diffuse coefficient (kd) for direct illumination.

		//returns diffuse from texture
		virtual color_t get_diffuse(const Vector2d coord) const override;
