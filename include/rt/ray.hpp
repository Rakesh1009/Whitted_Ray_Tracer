...
namespace rt
{
	...
	public:
		...
		ray_t reflected(const Vector3d& hitpt, const Vector3d& normal) const;
		ray_t transmitted(const Vector3d& hitpt, const Vector3d& normal, double ref_idx) const;
		// double getRefIdx() { return ref_idx; };
		// void setRefIdx(double refIdx) { ref_idx = refIdx; };
	};
}
