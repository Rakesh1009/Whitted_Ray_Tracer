...
namespace rt
{
 ...
 class scene_t
 {
   ...
   private:
    ...
    ///  Parse an string property.
    std::string parse_string(XMLElement* _elm, std::string property);
    ...
    /// Parse a solid surface material with texture.
    material_t* parse_texturemat(XMLElement* _elm);
